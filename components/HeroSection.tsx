...
const HeroSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative flex flex-col items-center justify-center text-center px-4 sm:px-6 py-18 sm:py-52 bg-gradient-to-br from-white via-blue-50 to-white overflow-hidden"
    >

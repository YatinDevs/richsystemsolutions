    ...
    >
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="px-6 pb-5 pt-3 border-t border-gray-100 ml-11">
              <motion.p
                className="text-gray-600 leading-relaxed font-[Inter] text-base font-light"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
...
const Faq = ({ subpage = 0 }: FaqProps) => {
  ...
  const filteredFaqs = faqs.filter((faq) => {
    if (
      ...
      subpage.details &&
      faq.product_name === subpage.details
    ) {
      return true;
    }
          ...
          >
            ...
            <div className="space-y-3 text-sm text-gray-500 font-[Inter]">
              <div className="flex items-center">
                ...
                <span>Comprehensive answers to all your queries</span>
              </div>
              <div className="flex items-center">
                <span className="w-2 h-2 bg-blue-500 rounded-full mr-3"></span>
                <span>Updated regularly with new information</span>
              </div>
              <div className="flex items-center">
                <span className="w-2 h-2 bg-purple-500 rounded-full mr-3"></span>
                <span>Can't find your answer? Contact us directly</span>
              </div>
            </div>
          </motion.div>
        </div>
